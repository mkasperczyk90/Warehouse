...
End-to-end tests for the [Operator terminal](../../../src/web/terminal/README.md), driven
...
`../../../src/web/terminal`, port **8081**) and waits for it — you don't start the app yourself.
