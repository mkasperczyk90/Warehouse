...
public sealed record RoomEnvironment
{
    ...
    /// <summary>EF Core materialization constructor: the nested <see cref="MaintainedTemperature"/>
    /// is an owned value object and is set via field access, not constructor binding.</summary>
    private RoomEnvironment()
    {
    }

    public TemperatureRange MaintainedTemperature { get; } = null!;
