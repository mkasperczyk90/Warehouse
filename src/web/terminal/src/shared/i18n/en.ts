...
export const en: Record<string, string> = {
  // app
  'app.name': 'WMS Terminal',

  // login (badge scan)
  'login.title': 'Sign in',
  'login.subtitle': 'Scan your badge to start your shift',
  'login.badgePlaceholder': 'Scan badge or type number…',
  'login.error': 'Badge not recognised — try again',
  'login.hint': 'Hold your badge to the reader, or type the number and press Enter',
