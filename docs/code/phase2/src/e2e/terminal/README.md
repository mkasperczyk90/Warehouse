...
The universal scan dispatch, read-only look-up, tab navigation and the PL/EN language
toggle are covered by `scan-dispatch`, `lookup`, `navigation` and `language` respectively.
