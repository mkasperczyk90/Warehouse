...
High-contrast theme (terminal-only), auth/identity UI, BI dashboards (the worklist landing is *not* BI),
external-actor portals. These are deferred in [`../../../docs/design/README.md`](../../../docs/design/README.md#scope).
